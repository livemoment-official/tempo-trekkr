        ...
        {messages.length > 0 && (
          <div className="container mx-auto px-4 pb-8">
            <div className="max-w-4xl mx-auto">
              <ScrollArea className="h-64 w-full rounded-xl border border-border/50 bg-card/50 backdrop-blur-sm p-6">
                <div className="space-y-4">
                  {messages.map((message, index) => (
                    ...
                    >
                      <div
                        className={`max-w-[80%] p-4 rounded-xl shadow-card ${
                          message.role === 'user'
                  ...
                  {loading && (
                    <div className="flex justify-start">
                      <div className="bg-card border border-border/50 p-4 rounded-xl shadow-card">
