  ...
  return <div className="min-h-screen bg-gradient-to-b from-background via-background to-primary/5">
      ...
      <div className="container mx-auto px-4 py-3 md:py-4 pb-[calc(72px+env(safe-area-inset-bottom))] md:pb-[calc(80px+env(safe-area-inset-bottom))] max-w-2xl">
        ...
        <div className="p-1 bg-muted/30 rounded-full mb-4 flex border border-border/50">
          <button onClick={() => setActiveTab('pro')} className={`flex-1 py-2.5 px-5 rounded-full text-xs font-medium transition-all duration-200 flex items-center justify-center gap-2 ${activeTab === 'pro' ? 'bg-primary text-white shadow-md ring-2 ring-black' : 'text-muted-foreground hover:text-foreground'}`}>
            <Crown className="h-4 w-4" />
            <span>Pro</span>
          </button>
          <button onClick={() => setActiveTab('business')} className={`flex-1 py-2.5 px-5 rounded-full text-xs font-medium transition-all duration-200 flex items-center justify-center gap-2 ${activeTab === 'business' ? 'bg-primary text-white shadow-md ring-2 ring-black' : 'text-muted-foreground hover:text-foreground'}`}>
