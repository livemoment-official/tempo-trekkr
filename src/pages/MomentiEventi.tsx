  ...
  const mockMoments = [
    {
      ...
      participants: 12,
      maxParticipants: 20,
      reactions: { hearts: 24, likes: 18, stars: 15, fire: 8 },
      mood: 'Rilassato'
    },
    {
      id: '2',
      ...
      participants: 14,
      maxParticipants: 22,
      reactions: { hearts: 12, likes: 28, stars: 9, fire: 15 },
      mood: 'Energico'
    },
    {
      id: '3',
      ...
      participants: 25,
      maxParticipants: 30,
      reactions: { hearts: 45, likes: 33, stars: 28, fire: 52 },
      mood: 'Divertente'
    },
    {
      id: '4',
      ...
      organizer: { name: 'Emma T.', avatar: '' },
      participants: 8,
      maxParticipants: 15,
      reactions: { hearts: 18, likes: 12, stars: 20, fire: 5 },
      mood: 'Tranquillo'
    }
  ];
