...
export function AICarousel({
  ...
  if (loading) {
    return <div className="space-y-4">
        ...
        <div className="flex gap-4 px-4 overflow-hidden">
          {Array.from({
          length: itemCount
        }).map((_, i) => <div key={i} className="flex-shrink-0 w-72">
  ...
  return <div className="space-y-6">
      <div className="flex items-center gap-3 px-4">
        ...
        <h3 className="bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent font-semibold text-sm">
          {title}
        </h3>
      </div>
