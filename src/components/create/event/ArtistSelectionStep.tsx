...
export default function ArtistSelectionStep({
  ...
  const handleSearch = (query: string) => {
    ...
    const filtered = mockArtists.filter(artist => artist.name.toLowerCase().includes(query.toLowerCase()) || artist.genres.some(genre => genre.toLowerCase().includes(query.toLowerCase())));
  ...
  return <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <Input value={searchQuery} onChange={e => handleSearch(e.target.value)} placeholder="Cerca artisti per nome o genere..." className="pl-10" />
      </div>
