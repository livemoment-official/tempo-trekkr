...
export default function EventPreviewStep({ data }: EventPreviewStepProps) {
    ...
    <div className="space-y-6">
          ...
          {data.selectedArtists.length > 0 && (
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {data.selectedArtists.map((artistId: string) => (
                  <div key={artistId} className="bg-muted/50 p-2 rounded flex items-center gap-2">
          ...
          {data.selectedVenues.length > 0 && (
            <div>
              ...
              <div className="grid grid-cols-1 gap-2">
                {data.selectedVenues.map((venueId: string) => (
                  <div key={venueId} className="bg-muted/50 p-2 rounded flex items-center gap-2">
            ...
            <div>
              ...
              <div className="bg-muted/50 p-4 rounded-lg">
                ...
                {data.callToAction.message && (
                  <p className="text-sm">{data.callToAction.message}</p>
                )}
              </div>
            </div>
          )}
      ...
      <div className="bg-muted/50 p-4 rounded-lg">
        ...
        <ul className="text-sm text-muted-foreground space-y-1">
          ...
          {data.callToAction.enabled && (
            <li>• Gli utenti potranno rispondere al tuo call-to-action</li>
          )}
        </ul>
      </div>
