...
export default function EventDetailsStep({ data, onChange, onNext }: EventDetailsStepProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            type="number"
            value={data.capacity || ""}
            onChange={(e) => onChange({ ...data, capacity: parseInt(e.target.value) || null })}
            placeholder="Es. 100"
            className="mt-2"
            min="1"
          />
