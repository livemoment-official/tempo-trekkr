-- Simple fix for notifications and test data

-- Just add the trigger function and related_id column
ALTER TABLE public.notifications ADD COLUMN IF NOT EXISTS related_id UUID;

-- Create function to create invite notifications (fixed)
...
-- Insert test profiles (ignore conflicts)
INSERT INTO public.profiles (id, user_id, display_name, username, avatar_url, interests, mood, job_title, location, privacy_level)
VALUES 
  (
