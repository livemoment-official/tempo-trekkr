-- Estendere la tabella profiles con nuovi campi
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS personality_type TEXT;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS chat_permission TEXT DEFAULT 'friends_only';
...
-- Creare enum per chat permissions
...
-- Aggiornare le colonne con i tipi enum corretti
ALTER TABLE public.profiles ALTER COLUMN chat_permission TYPE chat_permission_type USING chat_permission::chat_permission_type;
ALTER TABLE public.profiles ALTER COLUMN privacy_level TYPE privacy_level_type USING privacy_level::privacy_level_type;
ALTER TABLE public.profiles ALTER COLUMN personality_type TYPE personality_type USING personality_type::personality_type;
