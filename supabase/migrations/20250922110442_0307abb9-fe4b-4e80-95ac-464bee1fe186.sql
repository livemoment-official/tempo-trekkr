-- Populate invites table with real data for testing
...
BEGIN
    ...
    INSERT INTO public.invites (
        ...
        'Trek di una giornata sui Castelli Romani. Partenza alle 7:00!',
        marco_id,
        ARRAY[gabriele_id],
        NOW() - INTERVAL '1 day',
        '{"name": "Monte Cavo", "coordinates": [12.7064, 41.7612], "address": "Rocca di Papa, Roma"}'::jsonb,
        'rejected',
        1,
        false,
        15000,
        'Mi dispiace, ho già impegni questo weekend.',
        NOW() - INTERVAL '3 days',
        NOW() - INTERVAL '2 days'
    );
