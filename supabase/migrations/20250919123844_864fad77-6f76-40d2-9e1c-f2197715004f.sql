...
-- Add missing columns to group_messages (message_type already exists)
...
-- Create chat-media bucket for file uploads (only if not exists)
INSERT INTO storage.buckets (id, name, public) 
VALUES ('chat-media', 'chat-media', true)
ON CONFLICT (id) DO NOTHING;

-- Enable RLS on polls and poll_votes
